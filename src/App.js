    ...
    return (
        <div style={{display: "flex", flexDirection: "column", alignItems: "center"}}>
            ...
            <div style={{textAlign: "left"}}>
                <p>1. In the Github Projects tab, there are a mix of User Stories, Bugs, and Development Tasks
                    (dev-stories).</p>
                <p>2. For each of the cards, please complete the requirements to the best of your abilities.</p>
                <p>3. Submit any changes as a Pull Request to the Master branch.</p>

                <p>Note: Do not hesitate to ask for clarification in the comments of a particular card</p>
                <p>Good luck!</p>
            </div>
        </div>
    );
...
const FindBugThree = () => {
    ...
    return (
        <div>
            ...
            <br/>
            <button onClick={() => console.log(greet({name: 'Jacob'}))}>Click me!</button>
        </div>
    );
};
